...
const Login = ({ goToScreen, onComplete }) => {
  ...
  return (
    <div className="onboard-screen">
      {/* Back arrow */}
      <button className="back-arrow" onClick={() => goToScreen("signup")}>
        ←
      </button>

      <div className="image-area">
        <img src="/img/Family16.png" alt="Security" />
      </div>
      ...
      <div className="centered-form">
        ...
        <div className="forget-password">
          <button onClick={() => goToScreen("forgotPassword")}>
            Forget Password
          </button>
        </div>
      </div>
  ...
  <button className="social-btn google" onClick={() => console.log('Google login')}>
  ...
  <button className="social-btn apple" onClick={() => console.log('Apple login')}>
